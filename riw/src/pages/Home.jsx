...
import imgAgro from "../assets/articles/agro-forestry.png"
...
const UPDATES = [
  {
    ...
    location: "Western NY",
    summary: "Mixed-species windbreaks increased pollinator habitat and boosted soil organic carbon by 12–19% over 3 years in on-farm trials."
  },
  {
    ...
    summary: "Organic rotations showed richer functional guilds and stronger disease-suppressive signatures in metagenomic profiling."
  },
  {
    ...
    summary: "Deficit irrigation with soil-moisture triggers cut water use 22% while maintaining grain yield within 3% of controls."
  },
  {
    ...
    summary: "Cool-night tolerant lines out-performed baselines under late-spring frost and early-fall heat spikes across 12 sites."
  }
];
    ...
    <div className="container">
          ...
          {UPDATES.map((u, i) => (
            <article key={i} className="update-card">
              ...
              <div className="update-info">
                ...
                <button className="update-cta" aria-label={`Read more about ${u.title}`} onClick={() => location.hash = "#search"}>
      ...
      <section className="home-section mission">
        ...
        <p style={{ color: "rgb(25, 45, 43)" }}>
          Rooted In Water connects researchers, growers, and communities to advance resilient,
          evidence-based agriculture. We bridge datasets and field practice to turn observations into action.
        </p>
      </section>
